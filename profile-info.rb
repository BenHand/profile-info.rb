...
def print_profile
   puts "My name is #{$name} but you may know me as #{$username}, i am #{$age} years old and i am from #{$from.values.join(", ")}.\nThe following are a few of my favorite foods: #{$fav_food.join(", ")}!"
end
